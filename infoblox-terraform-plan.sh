...
echo "[Debug] 10. List current folder after running terraform plan"
ls -ail && pwd

terraform show -json infoblox_tfplan.tfplan > infoblox_tfplan.json

echo "[Debug] 11. List current folder after running terraform show"
ls -ail && pwd

cp infoblox_tfplan.json /sharedfolder/infoblox-workspace/infoblox_tfplan.json

echo "[Debug] 12. List sharedfolder folder after copying infoblox_tfplan.json to /sharedfolder"
